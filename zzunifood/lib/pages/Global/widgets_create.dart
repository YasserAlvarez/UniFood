...
// Carrito Card Viejo
class Card_Car_old extends StatefulWidget {
  ...
  const Card_Car_old({super.key, required this.nombre, required this.descripcion, required this.precio, required this.imagen });

  @override
  State<Card_Car_old> createState() => _Card_Car_oldState();
}

class _Card_Car_oldState extends State<Card_Car_old> {
